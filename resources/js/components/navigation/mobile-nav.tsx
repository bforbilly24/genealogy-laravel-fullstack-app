...
const MobileNav: React.FC<MobileNavProps> = ({ isMobileMenuOpen, setIsMobileMenuOpen }) => {
    return (
        <>
            ...
            >
                <div className="flex h-full flex-col">
                    <div className="flex items-center justify-between border-b border-gray-200 p-4 dark:border-gray-700">
                        ...
                        <Button variant="ghost" size="icon" onClick={() => setIsMobileMenuOpen(false)} className="text-black dark:text-white">
                            <X className="h-6 w-6" />
            ...
            {isMobileMenuOpen && <div className="fixed inset-0 z-[99] bg-black/50 md:hidden" onClick={() => setIsMobileMenuOpen(false)} />}
        </>
    );
};
